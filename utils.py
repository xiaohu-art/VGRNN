...
def mask_edges_prd(adjs_list):
    ...
    for adj in adjs_list:
        ...
        neg_edge_l.append(edges_false)

    return pos_edge_l, neg_edge_l
...
def mask_edges_prd_new(adjs_list, adj_orig_dense_list):
    ...
    neg_edge_l.append(np.asarray(edges_false))
